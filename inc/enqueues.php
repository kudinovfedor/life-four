...
function bw_enqueues()
{
    ...
    wp_register_script('utils-js', get_template_directory_uri() . '/assets/js/utils.js', array('jquery'),
        null, true);    
    wp_enqueue_script('utils-js');

    if (is_shop() || is_product_category( )) {
        wp_register_script('brainworks-filters-js', get_template_directory_uri() . '/assets/js/brainworks-filters.js', array('jquery'),
            null, true);    
        wp_enqueue_script('brainworks-filters-js');
    }
